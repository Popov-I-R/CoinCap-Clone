    ...
    <Container className="Footer-Body">
      <Row className="Footer-Container" xs="auto">
        <FooterColumnTitle>COINCAP.IO</FooterColumnTitle>
          ...
          <FooterLink link="https://shapeshift.zendesk.com/hc/en-us/requests/new">Support</FooterLink>
          <FooterLink link="https://docs.coincap.io/">Our API</FooterLink>
          <FooterLink link="https://coincap.io/rate-compare">Rate Comparison</FooterLink>
          <FooterLink link="https://shapeshift.com/contribute">Careers</FooterLink>
      </Row>
      <Row className="Footer-Container" xs="auto">
        <Col className="Footer-Column-Title">LEGALS</Col>
        <div className="Footer-Links">
          <FooterLink link="https://assets.coincap.io/documents/terms_of_service.pdf">Terms of Service</FooterLink>
          <FooterLink link="https://shapeshift.com/privacy?_ga=2.236483841.1051153332.1665657039-1607975974.1663429789">Privacy Policy</FooterLink>
        </div>
      ...
      <Row className="Footer-Container" xs="auto">
        ...
        <Col className="Social-Media-Icons">
          <a href="https://twitter.com/CoinCap_io"><FaTwitter/></a>
          <a href="https://www.facebook.com/watch/?v=365220420785166"><FaFacebookSquare/></a>
        </Col>
      </Row>
      <Row className="Footer-Container" xs="auto">
